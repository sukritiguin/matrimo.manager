...
import { onChnageCanvasPreset, setZoomLevel, updateCanvasStoreState } from "../store/canvasSlice";
import { TOrientation } from "../types";
import { useEditorCanvas } from "../hooks/useEditorCanvas";
import { useEffect, useState } from "react";
import { Point } from "fabric";

export const EditorCanvasActions = createReactContext(() => {
  ...
  }, [zoomLevel, canvas, canvasContainerRef]);
