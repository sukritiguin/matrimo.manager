...
export const editorIdParamsSchema = z.object({
  editorId: z.string().min(3, "Editor id - param is required"),
});

export const uploadIdParamsSchema = z.object({
  uploadId: z.string().min(1, "Upload id - param is required"),
});

export type EditorIdParamsSchema = z.infer<typeof editorIdParamsSchema>;
export type UploadIdParamsSchema = z.infer<typeof uploadIdParamsSchema>;
